...
resp.dat <- merge(lot05[c("row.no","county","treat","treat2","prize","prize2","one.prize","ba","wa","wi","orphan","widow","rgb","n.draw","slave.wealth.1820","candidate","prior.run","match.oh","match.votes","match.census")],
